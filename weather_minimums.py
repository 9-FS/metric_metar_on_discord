WEATHER_MIN={
    ...
    "CWC": 12*0.5144444,                                                    #! Seitenwindkomponente max. 20kt (10m/s)
    #"QNH_min": 95e3,                                                        #QNH min. wegen Höhenmesseinstellung
    #"QNH_max": 105e3,                                                       #QNH max. wegen Höhenmesseinstellung
    "RVR": 5e3,                                                             #Sicht min. 5km
    #"temp_min": 0,                                                         #Temperatur min. wegen Leistungstabellen und Vereisungsbedingungen
    "temp_max": 40,                                                         #Temperatur max. wegen Leistungstabellen
    ...
    "wind": 40*0.5144444                                                    #! Windstärke max. allgemein 40kt (20m/s)
}
